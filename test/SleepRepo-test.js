...
describe('SleepRepo', function() {
  ...
  it('should be able to find all users that average sleep quality greater than 3 for any week by id', function() {
    expect(sleepRepoSmall.getUsersOverThree()).to.equal([2, 3]);
  });
